        ...
        <div ref={containerRef} className="w-full bg-black text-white overflow-hidden relative font-sans">
            ...
            <section className="vision-section relative w-full min-h-screen flex flex-col justify-center items-center px-6 py-24 overflow-hidden">
                ...
                <div className="relative z-10 max-w-5xl w-full text-center space-y-12">
                    <div className="vision-text space-y-4">
                        <h2 className="text-[#00F0FF] tracking-[0.2em] text-sm md:text-base font-bold uppercase">The Declaration of a Digital Earth</h2>
                        <h1 className="text-4xl md:text-7xl font-extrabold tracking-tight leading-tight">
                            We Are Building<br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-[#00F0FF]">A Digital Earth.</span>
                        </h1>
                    ...
                    <div className="vision-text grid grid-cols-1 md:grid-cols-2 gap-12 text-left bg-white/5 backdrop-blur-sm p-8 md:p-12 rounded-2xl border border-white/10">
                        ...
                        <div className="space-y-6 flex flex-col justify-center border-l-2 border-[#00F0FF]/30 pl-8">
                            <p className="text-2xl md:text-3xl font-light text-white leading-snug">
                                "On the digital layer,<br />
                                <span className="font-bold text-[#00F0FF]">reality overlaps</span>,<br />
            ...
            <section className="features-section w-full px-6 py-32 bg-[#050505]">
                <div className="max-w-7xl mx-auto space-y-16">
                    <div className="text-center space-y-4 mb-20">
                        <h2 className="bento-item text-[#00F0FF] font-bold tracking-widest uppercase">Key Features</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-auto md:h-[600px]">
                        ...
                        <div className="bento-item col-span-1 md:col-span-1 row-span-2 bg-[#0A0A0A] rounded-3xl p-8 border border-white/5 hover:border-[#00F0FF]/30 transition-colors duration-500 overflow-hidden group relative">
                            <div className="absolute top-0 right-0 w-full h-1/2 bg-gradient-to-b from-[#00F0FF]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                            <div className="h-full flex flex-col justify-between relative z-10">
                                <div className="w-12 h-12 bg-[#00F0FF] rounded-full flex items-center justify-center mb-6">
                        ...
                        <div className="bento-item col-span-1 md:col-span-2 bg-[#111] rounded-3xl p-8 border border-white/5 relative overflow-hidden group">
                            ...
                            <div className="mt-8 flex items-center space-x-4">
                                <span className="px-4 py-2 bg-white/5 rounded-full text-xs uppercase tracking-wider text-[#00F0FF]">Local</span>
                                <div className="h-[1px] w-12 bg-gradient-to-r from-[#00F0FF] to-transparent"></div>
                        ...
                        <div className="bento-item col-span-1 md:col-span-2 bg-[#080808] rounded-3xl p-8 border border-white/5 relative overflow-hidden flex flex-col md:flex-row items-center cursor-pointer group hover:bg-[#0C0C0C] transition-colors">
                            ...
                            <div className="absolute inset-0 z-0 opacity-30 group-hover:opacity-50 transition-opacity duration-700">
                                <div className="w-full h-full bg-[url('/assets/kubic_surface.png')] bg-cover bg-center" />
                            </div>

                            <div className="relative z-10 w-full">
                                <h4 className="text-3xl font-bold mb-3"><span className="text-[#00F0FF]">Kubic.</span> The Ownable Surface.</h4>
                            ...
                            <div className="relative z-10 mt-6 md:mt-0 md:ml-auto">
                                <span className="inline-flex items-center justify-center w-16 h-16 rounded-full border border-white/20 group-hover:border-[#00F0FF] group-hover:text-[#00F0FF] transition-all">
            ...
            <section className="kubic-section w-full py-32 bg-black relative">
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10 grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
                    ...
                    <div className="col-span-1 md:col-span-4 space-y-8">
                        <h2 className="text-[#00F0FF] font-bold tracking-widest uppercase">KUBIC x LBS Posting</h2>
                        ...
                        <div className="pl-6 border-l-4 border-[#00F0FF]">
                    ...
                    <div className="col-span-1 md:col-span-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                        {[
                            ...
                            <div key={i} className="mechanism-step bg-[#111] p-8 rounded-2xl border border-white/5 hover:border-white/20 transition-colors relative overflow-hidden group">
                                <span className="text-6xl font-bold text-[#222] absolute top-4 right-4 group-hover:text-[#00F0FF]/20 transition-colors">{item.step}</span>
                                <div className="relative z-10 pt-12">
                                    <h4 className="text-xl font-bold mb-3">{item.title}</h4>
                                    <p className="text-gray-400 text-sm leading-relaxed">{item.desc}</p>
                                </div>
                                <div className="absolute bottom-0 left-0 h-1 bg-[#00F0FF] w-0 group-hover:w-full transition-all duration-700" />
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section className="economy-section w-full min-h-screen py-24 bg-[#030303] relative flex flex-col justify-center">
                ...
                <div className="absolute inset-0 opacity-20 pointer-events-none">
                    <div className="w-full h-full bg-[url('/assets/economy_flow.png')] bg-cover bg-center" />
                </div>

                <div className="max-w-7xl mx-auto px-6 w-full relative z-10">
                    <div className="text-center mb-20">
                        <h2 className="text-[#00F0FF] font-bold tracking-widest uppercase mb-4">Why Kubic Has Real Value</h2>
                        ...
                        <div className="economy-left bg-[#0A0A0A]/90 backdrop-blur rounded-3xl p-10 border border-white/10 space-y-10">
                            <div>
                                <h4 className="text-2xl font-bold mb-4 flex items-center">
                                    <span className="w-2 h-8 bg-[#00F0FF] mr-4 rounded-sm" />
                                ...
                                <ul className="mt-6 space-y-4">
                                    {['Kubic Owners', 'Content Creators', 'The Platform Ecosystem'].map((item) => (
                                        <li key={item} className="flex items-center text-white font-medium">
                                            <div className="w-2 h-2 rounded-full bg-[#00F0FF] mr-3" />
                                            {item}
                                        </li>
                                    ))}
                                </ul>
                        ...
                        <div className="economy-right space-y-8">
                            <div className="bg-[#111] p-8 rounded-2xl border border-white/5">
                                ...
                                <div className="grid grid-cols-2 gap-8">
                                    ...
                                    <div>
                                        <p className="text-xl font-bold text-[#00F0FF] mb-2">Kubic</p>
                                        <p className="text-sm text-gray-400">Value rises with posts, engagement, and global exposure.</p>
                                    </div>
                                </div>
                            </div>

                            <div className="bg-gradient-to-br from-[#001524] to-[#002a4d] p-10 rounded-3xl border border-[#00F0FF]/30 relative overflow-hidden text-center group">
                                ...
                                <button className="px-8 py-3 bg-[#00F0FF] text-black font-bold rounded-full hover:bg-white transition-colors relative z-10">
                                    Explore Marketplace
                                </button>
            ...
            <section className="global-section w-full h-[80vh] relative flex items-center justify-center overflow-hidden bg-black">
                ...
                <div className="relative z-10 text-center px-6 max-w-4xl mx-auto space-y-10">
                    <h2 className="text-5xl md:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-t from-[#00F0FF] to-white leading-tight">
                        Are You Ready?
                    </h2>
                    ...
                    <div className="pt-10">
                        <button className="px-12 py-5 bg-white text-black text-lg font-bold rounded-full hover:bg-[#00F0FF] hover:text-black hover:scale-105 transition-all duration-300 shadow-[0_0_40px_rgba(255,255,255,0.3)] hover:shadow-[0_0_60px_rgba(0,240,255,0.6)]">
                            Join Beta Now
                        </button>
                    </div>
